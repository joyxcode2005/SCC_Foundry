            ...
            {isModerator && (
                <div className="absolute top-4 right-4 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                    ...
                    {/* <button
                        ...
                        className="p-1.5 bg-white/90 border border-[var(--cream-border)] rounded-md text-[var(--text-secondary)] hover:text-red-500 hover:border-red-500 transition-colors"
